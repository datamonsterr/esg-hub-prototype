...
import { useSuppliers, useMaterialCodes, useProductCodes, useActionCodes, useCreateTraceabilityRequest } from "@/src/api/traceability"
...
export default function CreateTraceabilityRequestPage() {
  ...
  const { actionCodes } = useActionCodes()
  const { createRequest, isCreating } = useCreateTraceabilityRequest()
  ...
  const [selectedMaterialCodes, setSelectedMaterialCodes] = useState<string[]>(["MAT-001", "MAT-003"])
  const [selectedProductCodes, setSelectedProductCodes] = useState<string[]>(["PROD-001"])
  ...
  const handleSubmit = async () => {
    ...
    // Validate that the selected assessment exists and is completed
    ...
    const requestData: CreateTraceabilityRequest = {
      ...
      assessmentId,
      expirationDate: `${expirationDate}T${expirationTime || '00:00'}:00Z`,
      artifactTags: selectedMaterialCodes.concat(selectedProductCodes),
      actionTags: selectedActionCodes,
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link href="/traceability/request" className="text-gray-600 hover:text-brand-primary flex items-center space-x-2">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Select onValueChange={(value) => setSelectedMaterialCodes(prev => [...prev, value])}>
                  <SelectTrigger>
                    <SelectValue placeholder="Select or add material code" />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Select onValueChange={(value) => setSelectedProductCodes(prev => [...prev, value])}>
                  <SelectTrigger>
                    <SelectValue placeholder="Select or add product code" />
                  </SelectTrigger>
                  <SelectContent>
          ...
          <div>
            ...
            <div>
              ...
              <Select onValueChange={(value) => setSelectedActionCodes(prev => [...prev, value])}>
                <SelectTrigger>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="border border-gray-200 rounded-md p-4">
                ...
                <RadioGroup 
                  value={cascadeSettings.type} 
                  onValueChange={(value: 'required' | 'optional' | 'none') => 
                    setCascadeSettings(prev => ({ ...prev, type: value }))
                  }
                >
